 ...
 */
public abstract class JsonHelper extends AsyncTaskLoader<Cursor>
{
    ...
    public JsonHelper(Context context, String propertyName, String[] columnNames, int rawResourceId) {
        super(context);
